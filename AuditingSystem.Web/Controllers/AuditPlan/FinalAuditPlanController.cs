...
namespace AuditingSystem.Web.Controllers.AuditPlan
{
    public class FinalAuditPlanController : Controller
    {
        ...
        public FinalAuditPlanController(IBaseRepository<DraftAuditPlan, int> draftRepository,
        ...
        //            Year = group.Key.Year,
        //            Quarter = group.Key.Quarter,
        //            Plan = group.Any(item => item.Plan == true),
        //            Actual = group.Any(item => item.Actual == true)
        //        })
        //        .ToList<dynamic>();
