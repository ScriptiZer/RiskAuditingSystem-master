...
namespace AuditingSystem.Database.Migrations
{
    ...
    [Migration("20240328081631_modify_addColumns")]
    partial class modify_addColumns
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuditingSystem.Entities.AuditFieldWork.AuditProgramList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AuditProgramLists");
                });

            modelBuilder.Entity("AuditingSystem.Entities.AuditPlan.AuditBudget", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AuditResourcesListId");
            ...
            modelBuilder.Entity("AuditingSystem.Entities.AuditPlan.AuditBudgetList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AuditBudgetId");

                    b.ToTable("AuditBudgetLists");
                });

            modelBuilder.Entity("AuditingSystem.Entities.AuditPlan.AuditBudgetOperation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("OperationBudgetTypeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("OperationBudgetTypeId");

                    b.HasIndex("UserId");

                    b.ToTable("AuditBudgetOperation");
                });

            modelBuilder.Entity("AuditingSystem.Entities.AuditPlan.AuditBudgetOperationList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("AuditBudgetOperationId")
                        .HasColumnType("int");

                    b.Property<int>("BudgetOperationId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AuditBudgetOperationId");

                    b.ToTable("AuditBudgetOperationList");
                });
            ...
            modelBuilder.Entity("AuditingSystem.Entities.AuditPlan.AuditResources", b =>
                {
                    ...
                    b.ToTable("AuditResources");
                });

            modelBuilder.Entity("AuditingSystem.Entities.AuditPlan.AuditResourcesList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AuditResourcesLists");
                });

            modelBuilder.Entity("AuditingSystem.Entities.AuditPlan.AuditResourcesListStartEndDates", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("QuarterId1");

                    b.HasIndex("YearId1");

                    b.ToTable("AuditResourcesListStartEndDates");
                });

            modelBuilder.Entity("AuditingSystem.Entities.AuditPlan.DraftAuditPlan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("AuditResourceListId")
                        .HasColumnType("int");
                    ...
                    b.Property<bool?>("GovAudit")
                        .HasColumnType("bit");

                    b.Property<bool?>("IA")
                        .HasColumnType("bit");

                    b.Property<int?>("Insource")
                        .HasColumnType("int");

                    b.Property<bool?>("IsDeleted")
                        .HasColumnType("bit");

                    b.Property<bool?>("IsOneYear")
                        .HasColumnType("bit");

                    b.Property<bool?>("IsThreeYear")
                        .HasColumnType("bit");

                    b.Property<bool?>("IsTwoYear")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("DraftAuditPlans");
                });

            modelBuilder.Entity("AuditingSystem.Entities.AuditPlan.DraftAuditPlanList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AuditingSystem.Entities.AuditPlan.FinalAuditPlan", b =>
                {
                    ...
                    b.ToTable("FinalAuditPlans");
                });

            modelBuilder.Entity("AuditingSystem.Entities.AuditPlan.FinalAuditPlanList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("FinalAuditPlanId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FinalAuditPlanId");

                    b.ToTable("FinalAuditPlanLists");
                });
            ...
            modelBuilder.Entity("AuditingSystem.Entities.AuditProcess.Company", b =>
                {
                    ...
                    b.Property<string>("BudgetInsources")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("BudgetManager")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("BudgetOutsources")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("AuditingSystem.Entities.Setup.Calendar", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AuditingSystem.Entities.Setup.Permission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AuditingSystem.Entities.Setup.Quarter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AuditingSystem.Entities.Setup.RolesPermissions", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AuditingSystem.Entities.AuditFieldWork.AuditProgramList", b =>
                {
                    b.HasOne("AuditingSystem.Entities.AuditFieldWork.AuditProgram", "AuditProgram")
                        .WithMany("AuditProgramLists")
            ...
            modelBuilder.Entity("AuditingSystem.Entities.AuditPlan.AuditBudget", b =>
                {
                    b.HasOne("AuditingSystem.Entities.AuditPlan.AuditResourcesList", null)
                        .WithMany("AuditBudgets")
                        .HasForeignKey("AuditResourcesListId");
            ...
            modelBuilder.Entity("AuditingSystem.Entities.AuditPlan.AuditBudgetList", b =>
                {
                    b.HasOne("AuditingSystem.Entities.AuditPlan.AuditBudget", "AuditBudget")
                        .WithMany("AuditBudgetLists")
                        .HasForeignKey("AuditBudgetId");

                    b.Navigation("AuditBudget");
                });

            modelBuilder.Entity("AuditingSystem.Entities.AuditPlan.AuditBudgetOperation", b =>
                {
                    b.HasOne("AuditingSystem.Entities.Lockups.OperationBudgetType", "OperationBudgetType")
                        .WithMany()
                        .HasForeignKey("OperationBudgetTypeId");

                    b.HasOne("AuditingSystem.Entities.Setup.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId");

                    b.Navigation("OperationBudgetType");
            ...
            modelBuilder.Entity("AuditingSystem.Entities.AuditPlan.AuditBudgetOperationList", b =>
                {
                    b.HasOne("AuditingSystem.Entities.AuditPlan.AuditBudgetOperation", "AuditBudgetOperation")
                        .WithMany("AuditBudgetOperationLists")
                        .HasForeignKey("AuditBudgetOperationId");

                    b.Navigation("AuditBudgetOperation");
                });
            ...
            modelBuilder.Entity("AuditingSystem.Entities.AuditPlan.AuditResourcesList", b =>
                {
                    ...
                    b.HasOne("AuditingSystem.Entities.Setup.Year", null)
                        .WithMany("AuditResourcesList")
            ...
            modelBuilder.Entity("AuditingSystem.Entities.AuditPlan.AuditResourcesListStartEndDates", b =>
                {
                    ...
                    b.HasOne("AuditingSystem.Entities.Setup.Quarter", "Quarter")
                        .WithMany()
                        .HasForeignKey("QuarterId1");

                    b.HasOne("AuditingSystem.Entities.Setup.Year", "Year")
                        .WithMany()
            ...
            modelBuilder.Entity("AuditingSystem.Entities.AuditPlan.DraftAuditPlan", b =>
                {
                    ...
                    b.HasOne("AuditingSystem.Entities.AuditPlan.AuditResourcesList", "AuditResourcesList")
                        .WithMany()
                        .HasForeignKey("AuditResourcesListId");
                    ...
                    b.Navigation("AuditResourcesList");
            ...
            modelBuilder.Entity("AuditingSystem.Entities.AuditPlan.FinalAuditPlanList", b =>
                {
                    b.HasOne("AuditingSystem.Entities.AuditPlan.FinalAuditPlan", "FinalAuditPlan")
                        .WithMany("FinalAuditPlanLists")
                        .HasForeignKey("FinalAuditPlanId");

                    b.Navigation("FinalAuditPlan");
                });
            ...
            modelBuilder.Entity("AuditingSystem.Entities.Setup.RolesPermissions", b =>
                {
                    b.HasOne("AuditingSystem.Entities.Setup.Permission", "Permission")
            ...
            modelBuilder.Entity("AuditingSystem.Entities.AuditFieldWork.AuditProgram", b =>
                {
                    b.Navigation("AuditProgramLists");
                });

            modelBuilder.Entity("AuditingSystem.Entities.AuditPlan.AuditBudget", b =>
                {
                    b.Navigation("AuditBudgetLists");
                });

            modelBuilder.Entity("AuditingSystem.Entities.AuditPlan.AuditBudgetOperation", b =>
                {
                    b.Navigation("AuditBudgetOperationLists");
                });
            ...
            modelBuilder.Entity("AuditingSystem.Entities.AuditPlan.AuditResourcesList", b =>
                {
                    b.Navigation("AuditBudgets");
                });

            modelBuilder.Entity("AuditingSystem.Entities.AuditPlan.DraftAuditPlan", b =>
                {
                    b.Navigation("DraftAuditPlanLists");
                });

            modelBuilder.Entity("AuditingSystem.Entities.AuditPlan.FinalAuditPlan", b =>
                {
                    b.Navigation("FinalAuditPlanLists");
                });
