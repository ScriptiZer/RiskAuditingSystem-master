...
namespace AuditingSystem.Database.Migrations
{
    ...
    [Migration("20240117202656_AddFieldToCompanyToFillBudget")]
    partial class AddFieldToCompanyToFillBudget
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuditingSystem.Entities.AuditPlan.AuditResources", b =>
                {
                    ...
                    b.Property<string>("OutsourceId")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("QuartersId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("AuditingSystem.Entities.Setup.User", b =>
                {
                    ...
                    b.Property<int?>("AuditResourcesId1")
                        .HasColumnType("int");

                    b.Property<int?>("AuditResourcesId2")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AuditResourcesId1");

                    b.HasIndex("AuditResourcesId2");
            ...
            modelBuilder.Entity("AuditingSystem.Entities.Setup.Quarter", b =>
                {
                    b.HasOne("AuditingSystem.Entities.AuditPlan.AuditResources", null)
                        .WithMany("Quarters")
                        .HasForeignKey("AuditResourcesId");
            ...
            modelBuilder.Entity("AuditingSystem.Entities.Setup.User", b =>
                {
                    ...
                    b.HasOne("AuditingSystem.Entities.AuditPlan.AuditResources", null)
                        .WithMany("Managers")
                        .HasForeignKey("AuditResourcesId1");

                    b.HasOne("AuditingSystem.Entities.AuditPlan.AuditResources", null)
                        .WithMany("Outsources")
                        .HasForeignKey("AuditResourcesId2");
